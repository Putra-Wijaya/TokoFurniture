				...
				<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
					<div class="col-first">
						...
						<nav class="d-flex align-items-center">
							<a href="<?= base_url('welcome') ?>">Beranda<span class="lnr lnr-arrow-right"></span></a>
							<a href="<?= base_url('dashboard/belanja') ?>">Belanja</a>
						</nav>
					</div>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				...
				<section class="lattest-product-area pb-40 category-list">
					<div class="row">
						<!-- single product -->
						<?php foreach ($AksesorisdanDekorasi as $brg) : ?>
