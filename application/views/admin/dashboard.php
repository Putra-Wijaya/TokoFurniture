        ...
        <div class="row mrg20">
            ...
            <div class="col-md-8 col-sm-12 col-lg-12">
                <div class="wdgt-box rvnu-chrt">
                    <div class="wdgt-opt">
                        <a class="refrsh-btn" href="#" title="">
                            <i class="icon ion-ios-reload"></i>
                        </a>
                        <a class="expnd-btn" href="#" title="">
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th>Jumlah Barang</th>
                                    <th>Bukti Bayar</th>
                                    <!-- Menambahkan kolom untuk Bukti Bayar -->
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img
                                            src="<?php echo base_url('uploads/' . $row->bukti_pembayaran); ?>"
                                            alt="Bukti Bayar"
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="5">Tidak ada pesanan terbaru</td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
