							...
							<table class="table table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a href="<?php echo base_url('admin/data_barang/hapus/' . $brg->id_barang); ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Anda yakin ingin menghapus data barang ini?')">Hapus</a>
											<a href="<?php echo base_url('admin/data_barang/edit/' . $brg->id_barang); ?>" class="btn btn-sm btn-outline-info">Edit</a>
											<!-- aksi  -->
